...
import com.impressiontrackingrecyclerview.databinding.HorizontalVisibilityViewBinding
...
class HorizontalRecyclerAdapter(
...
) : RecyclerView.Adapter<HorizontalRecyclerAdapter.VisibilityView>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): VisibilityView {
        return VisibilityView(
            HorizontalVisibilityViewBinding.inflate(
    ...
    inner class VisibilityView(private val view: HorizontalVisibilityViewBinding) :
